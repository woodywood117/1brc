...
func init() {
	generateCmd.Flags().Int64P("count", "c", 1, "Number of rows to generate")
	generateCmd.Flags().StringP("output", "o", "measurements.txt", "Output file name")
